...
// <p>dasdasdsa</p> the text in between the paragraph tags is the innter text
 ...
 // to get the <i> nested inside of the <p> you have to do                             i = document.querySelector('p i'), then i.innerText, will give 'Sequoiadendron giganteum' you can you caps = i.innerText.toUpperCase() then do i.innerText = caps, to change the inner text to upper case, or do i.innerText=i.innerText.toUpperCase()
...
// textContent will show everything including the style tags   h1 {
   ...
   // inner text only shos 'human readable' content, text content shows every element including CSS styling which would not show up on the actual screen.